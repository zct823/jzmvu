...
//    self.displayedMessage = NSLocalizedStringWithDefaultValue(@"OverlayView displayed message", nil, [NSBundle mainBundle], @"Place a barcode inside the rectangle to scan it.", @"Place a barcode inside the rectangle to scan it.");
//  }
